...
- [檔案系統管理](檔案系統管理.md)
- [Win Service 操作](WinService操作.md)
- [Win環境變數](Win環境變數.md)
...
- [Chat－Windows裡的hardlink](https://www.perplexity.ai/search/zai-powershell-yao-ru-he-kan-c-EuXf7lidQoOudMQsKs4BZQ)
- 修改開機啟動應用程式
  desk.cpl→應用程式→啟動
...
- [Integrating .NET with PowerShell: Best Practices for Enhanced Scripting](https://www.scriptrunner.com/blog-admin-architect/dot-net-powershell-best-practice)
