...
- [Claude Code 換成了Kimi K2.5後，我再也回不去了](https://codelove.tw/@tony/post/qZQQEa)
- [在第三方 Coding Agent 中使用 | Kimi Code 文档](https://www.kimi.com/code/docs/more/third-party-agents.html)
- [Claude Code Router](https://musistudio.github.io/claude-code-router/)
- [Claude Code - Overview - Z.AI DEVELOPER DOCUMENT](https://docs.z.ai/devpack/tool/claude)
- [Qwen3-Coder](https://qwen.ai/blog?id=qwen3-coder)
- [Integration with Claude Code | OpenRouter | Documentation](https://openrouter.ai/docs/guides/coding-agents/claude-code-integration)
- [Claude Code - Ollama](https://docs.ollama.com/integrations/claude-code)
- [Claude Code with Qwen Models for Free | by Areejzaheer | Medium](https://medium.com/@areejzaheer96/claude-code-with-qwen-models-for-free-09679f1d3fff)
...
- [李卓軒 - Claude code 必裝插件 就是 Claude自己出的12金釵 超強der 一鍵安裝 /plugin... | Facebook](https://www.facebook.com/549213528/posts/10163856930353529)
