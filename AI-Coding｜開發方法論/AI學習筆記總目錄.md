...
- [AI時代的思考模式與工作流](AI時代的思考模式與工作流.md)
- 考慮工具的使用與模型的搭配
- 任務與LLM的搭配
- 與 AI 合作需要清楚什麼文件是要人為編寫，什麼文件由AI處理
...
- [Chat－Context engineering是什麼？](https://g.co/gemini/share/c877e1bd6c19)
- [How to Build AI Apps – A Frontend Developer's Guide](https://www.freecodecamp.org/news/frontend-ai-guide)
- [凱文大叔影片串-AI 程式開發](https://www.youtube.com/playlist?list=PL0uHVOLNEciaa-KGsU5YHIR8PFYwGhXUd)
- [凱文大叔影片串-Vibe Coding](https://www.youtube.com/playlist?list=PL0uHVOLNEciaN5qNotZoQaKdkLrNhkBAr)
...
- [LLMs.txt 是什麼？ | 產品先生](https://pagerank.ing/what-is-llms-txt/)
