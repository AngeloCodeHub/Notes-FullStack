...
- 縮排或Shift+Enter（巢狀 List）：TAB or Shift+TAB

## 雜記

- Yaml frontmatter 一定要從第0行開始
- 幾乎不會使用手機編輯筆記，如臨時遇到靈感
	1. google keep 快速記下
	2. 使用 Notion
	3. GitHub 直接線上編輯
	4. jopslin
- obsidian 會忽略（.）開頭的檔案或目錄
...
- [Obsidian教學｜Obsidian是什麼？跟Notion差在哪？如何用它生成「知識網路」筆記？|數位時代 BusinessNext](https://www.bnext.com.tw/article/84880/obsidian-tutorial-2025)
